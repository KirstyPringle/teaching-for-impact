...
It is for people with backgrounds in research and is adapted from [Greg Wilson's course on Organisational Change](https://github.com/gvwilson/change).
...
- Exercises work best in small groups (3-4 people)
- Works better if done synchronously, but can be done asynchronously
- All material is available under an open license
